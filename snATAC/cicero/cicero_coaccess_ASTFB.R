...
intATAC<-readRDS(file="objects/ATAC_AST-FB.RDS")
...
load('objects/genome_no_internet/genome_ASTFB.rda')
...
save(conns, file = "objects/cicero/ASTFB_cicero_conns.rda")
save(ccans, file = "objects/cicero/ASTFB_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_ASTFB.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_ASTFB.RDS")

pdf("figures/CoveragePlot_C9orf72_ASTFB.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

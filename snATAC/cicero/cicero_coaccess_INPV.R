...
intATAC<-readRDS(file="objects/ATAC_IN-PV.RDS")
...
load('objects/genome_no_internet/genome_INPV.rda')
...
save(conns, file = "objects/cicero/INPV_cicero_conns.rda")
save(ccans, file = "objects/cicero/INPV_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_INPV.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_INPV.RDS")

pdf("figures/CoveragePlot_C9orf72_INPV.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

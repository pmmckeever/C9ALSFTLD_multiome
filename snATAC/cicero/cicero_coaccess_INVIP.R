...
intATAC<-readRDS(file="objects/ATAC_IN-VIP.RDS")
...
load('objects/genome_no_internet/genome_INVIP.rda')
...
save(conns, file = "objects/cicero/INVIP_cicero_conns.rda")
save(ccans, file = "objects/cicero/INVIP_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_INVIP.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_INVIP.RDS")

pdf("figures/CoveragePlot_C9orf72_INVIP.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

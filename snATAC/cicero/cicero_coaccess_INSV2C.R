...
intATAC<-readRDS(file="objects/ATAC_IN-SV2C.RDS")
...
load('objects/genome_no_internet/genome_INSV2C.rda')
...
save(conns, file = "objects/cicero/INSV2C_cicero_conns.rda")
save(ccans, file = "objects/cicero/INSV2C_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_INSV2C.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_INSV2C.RDS")

pdf("figures/CoveragePlot_C9orf72_INSV2C.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

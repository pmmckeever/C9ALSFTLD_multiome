...
intATAC<-readRDS(file="objects/ATAC_L5-6CC.RDS")
...
load('objects/genome_no_internet/genome_L56CC.rda')
...
save(conns, file = "objects/cicero/L56CC_cicero_conns.rda")
save(ccans, file = "objects/cicero/L56CC_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_L56CC.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_L56CC.RDS")

pdf("figures/CoveragePlot_C9orf72_L56CC.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

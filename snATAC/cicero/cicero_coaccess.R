...
#made genome object due to computing cluster having no internet accesss
load('objects/genome_no_internet/genome.rda')
...
save(conns, file = "objects/cicero/intATAC_cicero_conns.rda")
save(ccans, file = "objects/cicero/intATAC_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links.RDS")

pdf("figures/CoveragePlot_C9orf72.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,

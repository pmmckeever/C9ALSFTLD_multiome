...
intATAC<-readRDS(file="objects/ATAC_IN-SST.RDS")
...
load('objects/genome_no_internet/genome_INSST.rda')
...
save(conns, file = "objects/cicero/INSST_cicero_conns.rda")
save(ccans, file = "objects/cicero/INSST_cicero_ccans.rda")

links<-ConnectionsToLinks(conns=conns,ccans=ccans)

saveRDS(links,file="objects/cicero/intATAC_cicero_links_unadded_INSST.RDS")

Links(intATAC)<-links

saveRDS(intATAC,file="objects/cicero/intATAC_cicero_links_INSST.RDS")

pdf("figures/CoveragePlot_C9orf72_INSST.pdf", height=7, width=11)
CoveragePlot(
  object = intATAC,
